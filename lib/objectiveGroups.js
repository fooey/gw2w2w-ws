...
Controller.getByMap = function(){
    return data;
};


Controller.getByObjective = function(){
    let objectives = {};

    _.forEach(data, function(map, mapName){
        _.forEach(map, function(mapSection, mapSectionName){
            _.forEach(mapSection.objectives, function(objectiveId){
