...
var dataUpdater = function () {
    ...
    */
    ...
    var callUpdaters = function(callback){
        ...
        async.parallel([
            ...
            var refreshTime = randRange(2.5*1000, 5*1000);
    ...
    */
    ...
    var now = function () {
        return myUtil.toUtcTimeStamp(Date.now());
    };

    var isStale = function (type, callback) {};
