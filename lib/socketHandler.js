...
var socketHandler = function (wss) {
    ...
    var processQueue = (function processQueue(){
        ...
        _.each(self.wss.clients, function(client, ixClient){
            ...
            if(clientMessages){
                console.log('WS Client Queue Processed:', client.uuid);
    ...
    // intentionall not using setInterval() this way it schedules the next batch in x seconds AFTER completing the current
    setTimeout(processQueue, 10*1000); 
